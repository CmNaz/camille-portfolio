...
class biHR(threading.Thread):
    ...
    def run(self):
        ...
        def on_openHR(w):
            for kline in client.get_historical_klines_generator(self.u.TRADE_SYMBOL, Client.KLINE_INTERVAL_1HOUR, "3 years ago"):
...
class bi15(threading.Thread):
    ...
    def run(self):
        ...
        def on_open(ws):
            for kline in client.get_historical_klines_generator(self.u.TRADE_SYMBOL, Client.KLINE_INTERVAL_15MINUTE, "3 years ago"):
